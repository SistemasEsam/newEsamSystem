<template>
  ...
  <div class="instructor-coordinator">
    <div class="invitation-page">
      <invitationheader class="letter-header"></invitationheader>
      <div class="main-content-letter">
        ...
        <div>
          <p>
            Estimado/a Docente:
            <br />Como preámbulo, reciba usted el más cordial saludo y deseos de
            éxito en las labores que desempeña como profesional sobresaliente;
            conocedores de su amplia experiencia profesional y conocimientos
            académicos, nos permitimos hacerle la presente invitación para que
            pueda formar parte de nuestro selecto plantel docente, y pueda
            compartir sus conocimientos y experiencias. La Escuela de Negocios
            ESAM está avalada bajo convenio con la Universidad Nacional Siglo
            XX, seguros de contar con su valiosa participación, comparto el
            cronograma y el contenido mínimo del módulo, así como todo lo
            relacionado a la estructura de calificación y honorarios
            profesionales:
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <br />
          <b>● Plataforma Moodle</b> (Plataforma asincrónica) donde se realizan
          las actividades y evaluaciones hacia los posgraduantes, por ello a su
          persona se le asigna un usuario y contraseña, para ingresar través de
          la siguiente URL (dirección de la plataforma):
          <br />
          <a href="url">
        ...
        <div>
          ...
          documentación:
          <br />
          ● Plan global de la materia (Nombre del módulo, objetivos específicos
          de enseñanza, metodología, recursos didácticos y material
          bibliográfico).
          <br />
        ...
        <div>
          ...
          <b>Las calificaciones deben registrarse en la Plataforma Moodle</b> de
          acuerdo al cronograma establecido de forma obligatoria, debiendo,
        ...
        <div>
          ...
          del cumplimento del plan global). <br />- Acta 02. Plan de Desarrollo
          Curricular (redacción en tiempo pasado del cumplimento del plan
          global).
          <br />
          <b>- Acta 03.</b> Planilla de Acta de Notas (calificaciones finales y
          observaciones).
          <br />
          <b>- Acta 04.</b> Desarrollo Curricular de Notas (las columnas pueden
          ser modificadas acorde a las actividades calificadas).
          <br />
          <b>- Acta 05.</b> Planilla de Acta de Notas de Segunda Instancia (nota
          única de 71 puntos). <br />Las actas deben presentarse de acuerdo al
          cronograma. El incumplimiento de esta cláusula deshabilita al docente
          para seguir dentro del plantel docente. <br />En caso de que surja
          algún inconveniente que impida su presencia en el desarrollo del
          módulo, deberá enviar su reemplazo con una preparación académica igual
          o superior a la suya, con el fin de velar la calidad académica que la
          Universidad imparte a los postgraduantes. <br /><b
          ...
          cuali cuanti que permita al docente mejorar las competencias
          pedagógicas y su recontratación. Correo Electrónico: Correo
          Coordinadora
        </div>
        <div>
          <h4>6. Honorarios profesionales</h4>
          A la conclusión del módulo en fechas establecidas en cronograma de
          clases, deberá realizar la presentación de las actas 01, 02 ,03, 04 de
          ...
          >
          es responsabilidad del docente cumplir las fechas para la efectuación
          de pago. <br />Asimismo aclarar que se enviará el formato de los
          informes y los mismos deberán ser firmados y enviados vía correo
          electrónico. <br /><b>Nota:</b> Deberá emitir la factura
          ...
          <b>CONSULTORES, SERVICIOS PROFESIONALES Y TÉCNICOS</b> para la emisión
          de factura por Servicios Profesionales. <br />Sin otro particular, me
          despido.
        </div>
        <br />
